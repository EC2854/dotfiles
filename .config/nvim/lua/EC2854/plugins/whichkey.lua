return {
    ...
    opts = {
        ...
        spec = {
            {
                { "<leader>/", "<cmd>lua require('fzf-lua').files()<CR>", desc = "Open File", nowait = true, remap = false },
                ...
                { "<leader>fc", "<cmd>lua require('fzf-lua').zoxide()<CR>", desc = "Change directory (zoxide)", nowait = true, remap = false },
                { "<leader>fl", "<cmd>FzfLua live_grep<CR>", desc = "Live grep", nowait = true, remap = false },
                { "<leader>fr", "<cmd>lua require('fzf-lua').oldfiles()<CR>", desc = "Open recent file", nowait = true, remap = false },

                { "<leader>b", group = "Buffers", nowait = true, remap = false },
                { "<leader>bi", "<cmd>lua require('fzf-lua').buffers()<CR>", desc = "ibuffer", nowait = true, remap = false },
